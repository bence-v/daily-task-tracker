                    ...
                    <form method="POST" action="{{ route('tasks.store') }}">
                        ...
                        <div class="block mt-4">
                            <label for="is_recurring" class="inline-flex items-center">
                                <input id="is_recurring" type="checkbox" class="rounded dark:bg-gray-900 border-gray-300 dark:border-gray-700 text-indigo-600 shadow-sm focus:ring-indigo-500 dark:focus:ring-indigo-600 dark:focus:ring-offset-gray-800" name="is_recurring" value="1" {{ old('is_recurring') ? 'checked' : '' }}>
